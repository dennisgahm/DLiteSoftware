import{S as l,i,s as r,n as o,d as m,a as c,b as x,c as h,g as p,e as g}from"../chunks/Dp6q8ILM.js";import"../chunks/IHki7fMi.js";const b=""+new URL("../assets/textbook-information-extraction1.2BvPLzPQ.webp",import.meta.url).href;function d(a){let t,s=`<h1 class="font-bold text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl text-secondary my-4 sm:my-6">Textbook Information Extraction</h1> <div class="shadow-lg bg-secondary/50 p-4 sm:p-6 md:p-8 lg:p-10 mb-6"><img class="mx-auto" alt="textbook-Information-extraction" src="${b}"/> <p class="text-lg sm:text-xl md:text-2xl lg:text-3xl font-semibold mt-6 mb-4">Textbook Information Extraction</p> <p class="my-4 text-sm sm:text-base md:text-lg">The <strong>Textbook Information Extraction</strong> program extracts textbook
      ...
      that the owner can also change the price he sells it.</p></div>`;return{c(){t=g("div"),t.innerHTML=s,this.h()},l(e){t=h(e,"DIV",{class:!0,"data-svelte-h":!0}),p(t)!=="svelte-4lq55c"&&(t.innerHTML=s),this.h()},h(){x(t,"class","max-w-6xl w-full px-4 sm:px-6 md:w-[90vw] lg:w-[80vw] xl:w-[70vw] mx-auto")},m(e,n){c(e,t,n)},p:o,i:o,o,d(e){e&&m(t)}}}class k extends l{constructor(t){super(),i(this,t,null,d,r,{})}}export{k as component};
